...
type Availability struct {
	...
	MatID        string `protobuf:"bytes,2,opt,name=matID,proto3" json:"matID,omitempty"`
...
func (x *Availability) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
func (x *Availability) GetMatID() string {
	if x != nil {
		return x.MatID
	}
	return ""
...
func (x *Availability) GetAvailability() string {
	if x != nil {
...
func (x *Availabilities) GetAvailability() []*Availability {
	if x != nil {
		return x.Availability
	}
	return nil
...
var file_availability_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0x64, 0x0a, 0x0c, 0x41, 0x76,
	0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x71, 0x75,
	0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x71, 0x75,
	0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x61, 0x74, 0x49, 0x44, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6d, 0x61, 0x74, 0x49, 0x44, 0x12, 0x22, 0x0a, 0x0c,
	...
	,
}
...
var file_availability_proto_goTypes = []interface{}{
	(*Availability)(nil),   // 0: main.Availability
	(*Availabilities)(nil), // 1: main.Availabilities
}
var file_availability_proto_depIdxs = []int32{
	0, // 0: main.Availabilities.availability:type_name -> main.Availability
